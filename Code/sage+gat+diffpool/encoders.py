...
class GcnEncoderGraph(nn.Module):
    def __init__(self, input_dim, hidden_dim, embedding_dim, label_dim, num_layers,
        ...
        self.pre_pred_model = self.build_pred_layers(self.pred_input_dim, pred_hidden_dims, embedding_dim, num_aggs=self.num_aggs)
        ...
        self.map2_model = self.build_pred_layers(pred_input_dim = embedding_dim, pred_hidden_dims=[], label_dim = 2)
