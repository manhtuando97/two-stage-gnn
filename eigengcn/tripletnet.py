...
class tripletnet(nn.Module):
    ...
    def forward(self, a, p, n):
        ...
        embed_a = self.model(a_h0, a_adj, a_batch_num_nodes, assign_x = a_assign_input)
        embed_p = self.model(p_h0, p_adj, p_batch_num_nodes, assign_x = p_assign_input)
        embed_n = self.model(n_h0, n_adj, n_batch_num_nodes, assign_x = n_assign_input)
